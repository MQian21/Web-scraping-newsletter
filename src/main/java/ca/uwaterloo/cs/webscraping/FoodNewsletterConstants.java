...
public interface FoodNewsletterConstants {

    //page link
    public final String FOOD_MENU_LINK= "https://uwaterloo.ca/food-services/locations-and-hours/daily-menu";

    //email server properties
    public final String MAIL_SERVER_HOST= "smtp.mailtrap.io";
